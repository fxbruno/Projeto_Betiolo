...
<body class="text-center">
  ...
  <form class="needs-validation" novalidate method="POST" action="valida.php">
      <img class="mb-4" src="imagens/betiolo.jpg" alt="" width="72" height="57" />
      <h1 class="h3 mb-3 fw-normal">Sistema Betiolo</h1>
      ...
      <p class="mt-1 mb-1 text-muted">Sistema Betiolo - All Rights Reserved</p>
